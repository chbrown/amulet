...
var Renderer = function(asap, callback, context) {
  this.initialize(asap, callback, context);
};
Renderer.prototype = new events.EventEmitter();
Renderer.prototype.initialize = function(asap, callback, context) {
  this.asap = asap;
...
var StreamRenderer = function(asap, callback, context) {
  this.initialize(asap, callback, context);
...
var StringRenderer = function(asap, callback, context) {
  this.initialize(asap, callback, context);
  this.string = '';
};
